...
function makeArticle(title, date, one, two, three){
  ...
  //appending elements to the article Div
  articleDiv.appendChild(articleHeader);
  articleDiv.appendChild(articleDate);
  articleDiv.appendChild(articleContentOne);
  articleDiv.appendChild(articleContentTwo);
  articleDiv.appendChild(articleContentThree);
...
data.forEach(objectData => {
  const { title, date, firstParagraph, secondParagraph, thirdParagraph } = objectData;

  const articles = makeArticle(title, date, firstParagraph, secondParagraph, thirdParagraph);
